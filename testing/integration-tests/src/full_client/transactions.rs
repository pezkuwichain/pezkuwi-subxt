...
#[subxt_test]
async fn v4_unsigned_encode_decode() -> Result<(), pezkuwi_subxt::Error> {
...
#[subxt_test]
async fn v5_bare_encode_decode() -> Result<(), pezkuwi_subxt::Error> {
    let ctx = test_context().await;
    let api = ctx.client();
    let md = api.metadata();
...
#[subxt_test]
async fn v4_signed_encode_decode() -> Result<(), pezkuwi_subxt::Error> {
    let ctx = test_context().await;
    let api = ctx.client();
    let md = api.metadata();
...
#[subxt_test]
async fn v5_general_encode_decode() -> Result<(), pezkuwi_subxt::Error> {
    let ctx = test_context().await;
    let api = ctx.client();
    let md = api.metadata();
