...
#[subxt_test]
async fn storage_plain_lookup() -> Result<(), pezkuwi_subxt::Error> {
...
#[cfg(fullclient)]
#[subxt_test]
async fn storage_map_lookup() -> Result<(), pezkuwi_subxt::Error> {
    let ctx = test_context().await;
    let api = ctx.client();
...
#[cfg(fullclient)]
#[subxt_test]
async fn storage_n_mapish_key_is_properly_created() -> Result<(), pezkuwi_subxt::Error> {
    use codec::Encode;
...
#[cfg(fullclient)]
#[subxt_test]
async fn storage_n_map_storage_lookup() -> Result<(), pezkuwi_subxt::Error> {
    let ctx = test_context().await;
    let api = ctx.client();
...
#[cfg(fullclient)]
#[subxt_test]
async fn storage_partial_lookup() -> Result<(), pezkuwi_subxt::Error> {
    let ctx = test_context().await;
    let api = ctx.client();
...
#[subxt_test]
async fn storage_runtime_wasm_code() -> Result<(), pezkuwi_subxt::Error> {
    let ctx = test_context().await;
    let api = ctx.client();
...
#[subxt_test]
async fn storage_pallet_storage_version() -> Result<(), pezkuwi_subxt::Error> {
    let ctx = test_context().await;
    let api = ctx.client();
...
#[subxt_test]
async fn storage_iter_decode_keys() -> Result<(), pezkuwi_subxt::Error> {
    use futures::StreamExt;
    ...
    let storage_dynamic =
        pezkuwi_subxt::dynamic::storage::<(scale_value::Value,), scale_value::Value>("System", "Account");
