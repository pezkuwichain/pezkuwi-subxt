...
#[subxt_test]
async fn tx_basic_transfer() -> Result<(), pezkuwi_subxt::Error> {
    let alice = dev::alice();
    let bob = dev::bob();
...
#[cfg(fullclient)]
#[subxt_test]
async fn tx_dynamic_transfer() -> Result<(), pezkuwi_subxt::Error> {
    use pezkuwi_subxt::ext::scale_value::{At, Value};
    ...
    let account_addr = pezkuwi_subxt::dynamic::storage::<(Value,), Value>("System", "Account");
...
#[subxt_test]
async fn multiple_sequential_transfers_work() -> Result<(), pezkuwi_subxt::Error> {
    let alice = dev::alice();
    let bob = dev::bob();
...
#[subxt_test]
async fn storage_balance_lock() -> Result<(), pezkuwi_subxt::Error> {
