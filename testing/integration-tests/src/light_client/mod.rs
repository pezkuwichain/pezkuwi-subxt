...
async fn finalized_headers_subscription(api: &Client) -> Result<(), pezkuwi_subxt::Error> {
    let now = std::time::Instant::now();
...
// Check that we can subscribe to non-finalized blocks.
async fn runtime_api_call(api: &Client) -> Result<(), pezkuwi_subxt::Error> {
    let now = std::time::Instant::now();
...
async fn storage_plain_lookup(api: &Client) -> Result<(), pezkuwi_subxt::Error> {
    let now = std::time::Instant::now();
...
async fn dynamic_constant_query(api: &Client) -> Result<(), pezkuwi_subxt::Error> {
    let now = std::time::Instant::now();
...
async fn dynamic_events(api: &Client) -> Result<(), pezkuwi_subxt::Error> {
    let now = std::time::Instant::now();
...
#[tokio::test]
async fn light_client_testing() -> Result<(), pezkuwi_subxt::Error> {
